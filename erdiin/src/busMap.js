                        ...
                        <ul className="category">
                            ...
                            <li id="office" className="facility_info">
                                <button className="btn room" onClick={() => facLoc.changeMarker('office', map)}>
                                    <img className="facilityIcon" src="https://github.com/JNU-erdiin/JNU_InformationWeb/blob/main/img/phone.png?raw=true" alt="과사무실 아이콘"/>
                                    과사무실
                                </button>
                            </li>
                            <li id="rstrt" className="facility_info">
                                <button className="btn cafe" onClick={() => facLoc.changeMarker('rstrt', map)}>
                                    <img className="facilityIcon" src="https://github.com/JNU-erdiin/JNU_InformationWeb/blob/main/img/cutlery.png?raw=true" alt="식당아이콘"/>
                                    식당
                                </button>
                            </li>
                            <li id="print" className="facility_info">
                                <button className="btn cafe" onClick={() => facLoc.changeMarker('print', map)}>
                                    <img className="facilityIcon" src="https://github.com/JNU-erdiin/JNU_InformationWeb/blob/main/img/printing.png?raw=true" alt="프린터기 아이콘"/>
                                    프린터기
                                </button>
                            </li>
                            <li id="etc" className="facility_info">
                                <button className="btn cafe" onClick={() => facLoc.changeMarker('etc', map)}>
                                    <img className="facilityIcon" src="https://github.com/JNU-erdiin/JNU_InformationWeb/blob/main/img/information.png?raw=true" alt="기타 아이콘"/>
                                    기타
                                </button>
                            </li>
                        </ul>
