...
export const Header = () => {
  ...
  const showFacList = (mode) => {
    ...
    if (mode === "store") {
      ...
      for (let i = 0; i < facPos.positionCvtStore.length; i++) {
        str =
          str + '<p class="list">' + facPos.positionCvtStore[i].title + " </p>";
      }
    } else if (mode === "atm") {
      ...
      for (let i = 0; i < facPos.positionRstrt.length; i++) {
        str =
          str + '<p class="list">' + facPos.positionRstrt[i].title + " </p>";
      }
    } else if (mode === "etc") {
      ...
      for (let i = 0; i < facPos.positionPrint.length; i++) {
        str =
          str + '<p class="list">' + facPos.positionPrint[i].title + " </p>";
      }
    }
  ...
  function createBusContent(title, name, num) {
    let str =
      "<li><p id = 'busli' style = 'border-bottom : 1px solid lightgrey'>" +
      title +
      "</p></li>";
    return str;
  }
  ...
  return (
    <div>
      <div className="navBar-wrapper">
        <ul className="navBar">
          <li id="busHome" onClick={toggleMenu}>
            순환버스
          </li>
          <li id="classHome" onClick={toggleMenu}>
            학과정보
          </li>
          <li id="facHome" onClick={toggleMenu}>
            시설정보
          </li>
        </ul>
      </div>
      <div
        className={
          isOpen.busHome
            ? "navBar-contents show-menu"
            : "navBar-contents hide-menu"
        }
      >
        <div className="busnavbar">
          <div className="busnav-header">
            <p>버스를 선택해주세요.</p>
            <div id="busbtn">
              <button className="blue" onClick={() => showBus("A")}>
                A
              </button>
              <button className="red" onClick={() => showBus("B")}>
                B
              </button>
            </div>
          </div>
          <div className="busnav-content">
            <div className="cnt-header">
              ...
              <p
                id="timetable"
                onClick={() =>
                  alert("팝업창을 띄우려했지만 귀찮아서.... 일단 함정이에요...")
                }
              >
                운행시간표
              </p>
          ...
          <ul className="navCategory">
            <li id="store" className="facility_info">
              <button className="btn conv" onClick={() => showFacList("store")}>
                <img
                  ...
                  src="https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/store.png"
                  alt="편의점아이콘"
                />
                편의점
              </button>
            ...
            <li id="atm" className="facility_info">
              <button className="btn atm" onClick={() => showFacList("atm")}>
                <img
                  className="facilityIcon"
                  src="https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/atm.png"
                  alt="atm아이콘"
                />
                ATM
              </button>
            ...
            <li id="rstrt" className="facility_info">
              <button className="btn cafe" onClick={() => showFacList("rstrt")}>
                <img
                  className="facilityIcon"
                  src="https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/restaurant.png"
                  alt="식당아이콘"
                />
                식당
              </button>
            ...
            <li id="print" className="facility_info">
              <button className="btn cafe" onClick={() => showFacList("print")}>
                <img
                  className="facilityIcon"
                  src="https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/print.png"
                  alt="프린터기 아이콘"
                />
                프린터기
              </button>
            ...
            <li id="etc" className="facility_info">
              <button className="btn etc" onClick={() => showFacList("etc")}>
                <img
                  className="facilityIcon"
                  src="https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/information.png"
                  alt="기타 아이콘"
                />
                기타
              </button>
