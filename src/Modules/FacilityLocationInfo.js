...
export const createOfficeMarkers = () => {
  //사무실 마커 이미지 주소(blue)
  const officeMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/bluepin.png";
...
export const createEtcMarkers = () => {
  //기타시설 마커 이미지 주소(grey)
  const etcMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/greypin.png";
...
export const createRstrtMarkers = () => {
  //식당 마커 이미지 주소(orange)
  const rstrtMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/orangepin.png";
...
export const createStoreMarkers = () => {
  //매점 마커 이미지 주소(red)
  const storeMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/redpin.png";
...
export const createPrintMarkers = () => {
  ...
  const printMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/greenpin.png";
...
export const createAtmMarkers = () => {
  ...
  const atmMarker =
    "https://raw.githubusercontent.com/dhflxhdxhd/erdiin-JNU-information/main/erdiin_web/img/purplepin.png";
